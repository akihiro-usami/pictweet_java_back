        ...
        http
                ...
                .cors(cors -> cors
                        .configurationSource(request -> {
                            ...
                            corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000", "https://pictweet-nextjs-front.vercel.app"));
                            corsConfiguration
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers(HttpMethod.GET, "/css/**", "/images/**", "/tweets/{id:[0-9]+}", "/error")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/tweets/", "/api/tweets/{if:[0-9]+}",
                                "/api/users/{id:[0-9]+}", "/api/tweets/search")
                        .permitAll()
